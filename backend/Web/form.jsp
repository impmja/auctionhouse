...
<p>Last Name: <input name="lastname" type="text" size="30"
	id="lastname"></p>
<br>
<p>Street: <input name="street" type="text" size="30" id="street">
<input name="number" type="text" size="3" id="number"></p>
<p>Postal Code: <input name="postalcode" type="text" size="5"
	id="postalcode"></p>
