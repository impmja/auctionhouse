...
<body>
<div id="header"><a href="index.jsp">
<h2>eBay 2.0</h2>
</a> <%
 	// Login request?
 	...
 	try {
 		...
 		if (user != null) {
 			out.println("<p>Sie sind angemeldet als: "
 					+ user.getValue("email") + "</p>");
 %>
<div id="form">
<p><a href="purchases.jsp"><input type="submit" name="purchases"
	value="Purchases" style="position: relative; left: 284px"></a></p>
<form action="index.jsp" method="post"><input type="hidden"
	name="is_logout">
<p><input type="submit" name="logout" value="Logout"
	style="position: relative; left: 284px"></p>
</form>
</div>
<%
	} else {
...
<p><input name="email" type="text" size="20" value="E-Mail"
	onclick="this.value='';"
	onblur="this.value=!this.value?'E-Mail':this.value;"> <input
