...
public class Bid implements IModel {
	public Map<String, String>	fields = new HashMap<String, String>();
	public Map<String, Object>	relations = new HashMap<String, Object>();
	
	public static final String RENAMED_FIELDS[] = { "bid_id" };
	public static final String FIELDS[] = { "id", "bid", "bid_date" };
	public static enum FIELD_INDEX { ID, BID, BID_DATE };
	public static final String RELATIONS[] = { "bidder", "article" }; 
		
	public Bid(ResultSet _result) throws SQLException {
